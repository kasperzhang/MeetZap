...
import { doesSurveyActivateByAction, doesSurveyActivateByEvent, isSurveyRunning, SURVEY_LOGGER as logger, SURVEY_SEEN_PREFIX, } from './utils/survey-utils';
...
var PostHogSurveys = /** @class */ (function () {
    ...
    PostHogSurveys.prototype.reset = function () {
        ...
        for (var i = 0; i < localStorage.length; i++) {
            ...
            if (key === null || key === void 0 ? void 0 : key.startsWith(SURVEY_SEEN_PREFIX)) {
                surveyKeys.push(key);
            }
        }
    ...
    PostHogSurveys.prototype.getSurveys = function (callback, forceReload) {
        ...
        var existingSurveys = this._instance.get_property(SURVEYS);
        ...
        try {
            ...
            this._instance._send_request({
                ...
                callback: function (response) {
                    ...
                    (_c = _this._instance.persistence) === null || _c === void 0 ? void 0 : _c.register((_a = {}, _a[SURVEYS] = surveys, _a));
    ...
    PostHogSurveys.prototype.renderSurvey = function (surveyId, selector) {
        ...
        var elem = document === null || document === void 0 ? void 0 : document.querySelector(selector);
        if (!survey) {
