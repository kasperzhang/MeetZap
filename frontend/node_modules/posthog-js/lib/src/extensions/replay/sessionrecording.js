...
var SessionRecording = /** @class */ (function () {
    ...
    Object.defineProperty(SessionRecording.prototype, "_fullSnapshotIntervalMillis", {
        get: function () {
            var _a, _b;
            if (this._triggerStatus === 'trigger_pending') {
                return ONE_MINUTE;
            }
    ...
    Object.defineProperty(SessionRecording.prototype, "_isSampled", {
        get: function () {
            var currentValue = this._instance.get_property(SESSION_RECORDING_IS_SAMPLED);
    ...
    Object.defineProperty(SessionRecording.prototype, "_isRecordingEnabled", {
        get: function () {
            var enabled_server_side = !!this._instance.get_property(SESSION_RECORDING_ENABLED_SERVER_SIDE);
    ...
    Object.defineProperty(SessionRecording.prototype, "_isConsoleLogCaptureEnabled", {
        get: function () {
            var enabled_server_side = !!this._instance.get_property(CONSOLE_LOG_RECORDING_ENABLED_SERVER_SIDE);
    ...
    Object.defineProperty(SessionRecording.prototype, "_canvasRecording", {
        get: function () {
            ...
            var canvasRecording_server_side = this._instance.get_property(SESSION_RECORDING_CANVAS_RECORDING);
    ...
    Object.defineProperty(SessionRecording.prototype, "_networkPayloadCapture", {
        ...
        get: function () {
            var _a, _b;
            var networkPayloadCapture_server_side = this._instance.get_property(SESSION_RECORDING_NETWORK_PAYLOAD_CAPTURE);
            ...
            var clientConfigForPerformanceCapture = isObject(this._instance.config.capture_performance)
    ...
    Object.defineProperty(SessionRecording.prototype, "_masking", {
        get: function () {
            var _a, _b, _c, _d, _e, _f;
            var masking_server_side = this._instance.get_property(SESSION_RECORDING_MASKING);
    ...
    Object.defineProperty(SessionRecording.prototype, "_sampleRate", {
        get: function () {
            var rate = this._instance.get_property(SESSION_RECORDING_SAMPLE_RATE);
    ...
    Object.defineProperty(SessionRecording.prototype, "_minimumDuration", {
        get: function () {
            var duration = this._instance.get_property(SESSION_RECORDING_MINIMUM_DURATION);
    ...
    Object.defineProperty(SessionRecording.prototype, "_urlTriggerStatus", {
        get: function () {
            var _a;
            ...
            return currentTriggerSession === this._sessionId ? 'trigger_activated' : 'trigger_pending';
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SessionRecording.prototype, "_eventTriggerStatus", {
        get: function () {
            var _a;
    ...
    Object.defineProperty(SessionRecording.prototype, "_triggerStatus", {
        get: function () {
            var eitherIsActivated = this._eventTriggerStatus === 'trigger_activated' || this._urlTriggerStatus === 'trigger_activated';
            var eitherIsPending = this._eventTriggerStatus === 'trigger_pending' || this._urlTriggerStatus === 'trigger_pending';
            ...
            if (!this._onSessionIdListener) {
                this._onSessionIdListener = this._sessionManager.onSessionId(function (sessionId, windowId, changeReason) {
                    ...
                    if (changeReason) {
                        ...
                        (_b = (_a = _this._instance) === null || _a === void 0 ? void 0 : _a.persistence) === null || _b === void 0 ? void 0 : _b.unregister(SESSION_RECORDING_EVENT_TRIGGER_ACTIVATED_SESSION);
                        (_d = (_c = _this._instance) === null || _c === void 0 ? void 0 : _c.persistence) === null || _d === void 0 ? void 0 : _d.unregister(SESSION_RECORDING_URL_TRIGGER_ACTIVATED_SESSION);
                    }
                });
            }
        }
    ...
    SessionRecording.prototype.onRemoteConfig = function (response) {
        ...
        if (!isNullish(this._linkedFlag) && !this._linkedFlagSeen) {
            ...
            this._instance.onFeatureFlags(function (_flags, variants) {
    ...
    SessionRecording.prototype._startCapture = function (startReason) {
        ...
        if (!getRRWebRecord()) {
            (_b = (_a = assignableWindow.__PosthogExtensions__) === null || _a === void 0 ? void 0 : _a.loadExternalDependency) === null || _b === void 0 ? void 0 : _b.call(_a, this._instance, this._scriptName, function (err) {
                if (err) {
    ...
    Object.defineProperty(SessionRecording.prototype, "_scriptName", {
        get: function () {
            var _a, _b, _c;
            return (((_c = (_b = (_a = this._instance) === null || _a === void 0 ? void 0 : _a.persistence) === null || _b === void 0 ? void 0 : _b.get_property(SESSION_RECORDING_SCRIPT_CONFIG)) === null || _c === void 0 ? void 0 : _c.script) || 'recorder');
        },
        enumerable: false,
        configurable: true
    });
    ...
    SessionRecording.prototype._onScriptLoaded = function () {
        ...
        this._mutationRateLimiter =
            (_e = this._mutationRateLimiter) !== null && _e !== void 0 ? _e : new MutationRateLimiter(rrwebRecord, {
    ...
    SessionRecording.prototype.onRRwebEmit = function (rawEvent) {
        ...
        if (rawEvent.type === EventType.FullSnapshot && this._triggerStatus === 'trigger_pending') {
            this._clearBuffer();
        }
        var throttledEvent = this._mutationRateLimiter
