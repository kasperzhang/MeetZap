...
import { canActivateRepeatedly, createShadow, defaultSurveyAppearance, dismissedSurveyEvent, doesSurveyDeviceTypesMatch, doesSurveyMatchSelector, doesSurveyUrlMatch, getContrastingTextColor, getDisplayOrderQuestions, getSurveyContainerClass, getSurveyResponseKey, getSurveySeen, hasWaitPeriodPassed, sendSurveyEvent, style, SURVEY_DEFAULT_Z_INDEX, SurveyContext, } from './surveys/surveys-extension-utils';
        ...
        var showSurvey = function () {
            ...
            setTimeout(function () {
                ...
                var inputField = (_b = (_a = document
                    .querySelector(getSurveyContainerClass(survey, true))) === null || _a === void 0 ? void 0 : _a.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector('textarea, input[type="text"]');
                if (inputField) {
                    inputField.focus();
                }
            }, 100);
