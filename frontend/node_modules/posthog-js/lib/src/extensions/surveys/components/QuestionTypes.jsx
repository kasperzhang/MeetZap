...
export function RatingQuestion(_a) {
    ...
    return (<Fragment>
            <div className="question-container">
                ...
                return (<button className={"ratings-emoji question-".concat(displayQuestionIndex, "-rating-").concat(idx, " ").concat(active ? 'rating-active' : '')} value={idx + 1} key={idx} type="button" onClick={function () {
                        setRating(idx + 1);
                    }} style={{
                        fill: active
...
export function RatingButton(_a) {
    ...
    return (<button className={"ratings-number question-".concat(displayQuestionIndex, "-rating-").concat(num, " ").concat(active ? 'rating-active' : '')} type="button" onClick={function () {
            setActiveNumber(num);
        }} style={{
            color: getContrastingTextColor(active ? appearance.ratingButtonActiveColor : appearance.ratingButtonColor),
