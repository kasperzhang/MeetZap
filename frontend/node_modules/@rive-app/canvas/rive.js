...
1;return 1},178886:()=>{"undefined"!==typeof window.sa&&(--window.sa.Ab,0===window.sa.Ab&&delete window.sa)},179050:()=>void 0!==navigator.mediaDevices&&void 0!==navigator.mediaDevices.getUserMedia,179154:()=>{try{var a=new (window.AudioContext||window.webkitAudioContext),b=a.sampleRate;a.close();return b}catch(c){return 0}},179325:(a,b,c,d,e,f)=>{if("undefined"===typeof window.sa)return-1;var g={},m={};a==window.sa.Ha.zb&&0!=c&&(m.sampleRate=c);g.Ia=new (window.AudioContext||window.webkitAudioContext)(m);
...
u=g.tb,x=0;x<d;x+=1)t[x]=u[x*b+k];else for(k=0;k<n.outputBuffer.numberOfChannels;++k)n.outputBuffer.getChannelData(k).fill(0)};a!=window.sa.Ha.capture&&a!=window.sa.Ha.Lb||navigator.mediaDevices.getUserMedia({audio:!0,video:!1}).then(function(n){g.Db=g.Ia.createMediaStreamSource(n);g.Db.connect(g.Za);g.Za.connect(g.Ia.destination)}).catch(function(n){console.log("Failed to get user media: "+n)});a==window.sa.Ha.zb&&g.Za.connect(g.Ia.destination);g.qc=f;return window.sa.Gd(g)},182202:a=>window.sa.sb(a).Ia.sampleRate,
182275:a=>{a=window.sa.sb(a);void 0!==a.Za&&(a.Za.onaudioprocess=function(){},a.Za.disconnect(),a.Za=void 0);void 0!==a.Db&&(a.Db.disconnect(),a.Db=void 0);a.Ia.close();a.Ia=void 0;a.qc=void 0},182675:a=>{window.sa.Dc(a)},182725:a=>{a=window.sa.sb(a);a.Ia.resume();a.state=window.sa.gb.yc},182864:a=>{a=window.sa.sb(a);a.Ia.suspend();a.state=window.sa.gb.stopped}},db=a=>{for(;0<a.length;)a.shift()(l)},eb=(a,b)=>{for(var c=0,d=a.length-1;0<=d;d--){var e=a[d];"."===e?a.splice(d,1):".."===e?(a.splice(d,
